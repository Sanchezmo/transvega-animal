...
class InvoiceIntegrationService:
    ...
    async def get_supplier_by_tax_id(self, tax_id: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def invoice_exists(self, supplier_tax_id: str, invoice_number: str) -> bool:
        ...
        try:
            ...
            logger.error("invoice_exists_check_failed", tax_id=supplier_tax_id, invoice_number=invoice_number, error=str(e))
