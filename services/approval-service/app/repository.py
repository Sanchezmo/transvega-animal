...
from app.models import (
    ApprovalRequest, ApprovalStatus, ApprovalPriority, ApprovalAction,
    ApprovalComment, ApprovalHistory, ApprovalRule
)
from app.schemas import ApprovalRequestCreate, ApprovalDecision
from app.schemas import ApprovalListResponse, ApprovalStats
...
class ApprovalRepository:
    ...
    async def get_by_id(self, approval_id: UUID) -> Optional[dict]:
