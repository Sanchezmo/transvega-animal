...
class VeriFactuAdapter:
    ...
    def __init__(self, config: Dict):
        ...
        self.endpoint = config.get("VERIFACTU_ENDPOINT", "https://www2.agenciatributaria.gob.es/wlpl/BNR-Verifactu/VeriFactu")
    ...
    def _validate_invoice_data(self, data: Dict) -> Dict:
        ...
        required = [
            "invoice_number", "date", "type", "issuer", "receiver", 
            "lines", "total_ht", "total_vat", "total_ttc"
        ]
...
'''
        ...
        for i, line in enumerate(data.get("lines", []), 1):
            ...
            line_total = round((line.get("unit_price", 0) * line.get("quantity", 1)) * (1 - line.get("discount", 0)/100), 2)
