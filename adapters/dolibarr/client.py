...
class DolibarrClient:
    ...
    async def upload_document(self, resource_type: str, resource_id: int, file_data: bytes, filename: str) -> Dict[str, Any]:
    ...
    async def update_supplier_invoice_line(self, invoice_id: int, line_id: int, line_data: Dict[str, Any]) -> Dict[str, Any]:
