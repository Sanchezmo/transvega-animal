...
def save_uploaded_file(
    ...
    # Get directories
    try:
        original_dir, processed_dir, social_dir, listing_dir = ensure_media_dirs(dog_internal_id)
...
def get_media_file_path(dog_internal_id: str, file_hash: str, purpose: str) -> Optional[Path]:
