...
class TechnicalAgent:
    ...
    async def _monitor_services(self, data: Dict) -> Dict:
        ...
        services = [
            "api", "worker", "approvals", "dashboard", 
            "audit-db", "redis", "mock-dolibarr", "ollama",
    ...
    async def _check_cpu_memory_disk(self, data: Dict) -> Dict:
        ...
        return {
            ...
            "memory": {"percent": memory.percent, "used_gb": round(memory.used / 1024**3, 2), "total_gb": round(memory.total / 1024**3, 2)},
