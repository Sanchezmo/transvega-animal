...
def upgrade() -> None:
    ...
    sa.Enum("low", "medium", "high", "critical", name="approval_priority", create_type=True)
    ...
    op.create_table(
        ...
        sa.Column(
            "rule_id", sa.Uuid(as_uuid=True), sa.ForeignKey("approval_rules.id", ondelete="CASCADE"), nullable=False
        ),
