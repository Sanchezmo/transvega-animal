...
from bot.metrics import (
    record_ad_found, record_ad_renewed, record_ad_failed, record_ad_skipped,
    record_renewal_duration, record_run_duration, record_run_complete,
    record_captcha_hit, set_active_ads, set_current_renewing,
    record_login_duration,
)
from bot.alerts import send_alert, send_captcha_alert, send_login_failed_alert
...
class AdInfo:
    ...
    renew_button: Optional[Locator] = None
...
async def _parse_ad_element(page: Page, element: Locator) -> Optional[AdInfo]:
...
async def random_delay() -> None:
    ...
    delay = random.uniform(
        settings.RENEWAL_DELAY_MIN,
        settings.RENEWAL_DELAY_MAX
    )
